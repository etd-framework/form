...
class MaskedTextField extends Field {
    ...
    protected function getInput() {
        ...
        (new RequireJSUtility())
            ->addRequireJSModule("jquery.inputmask", "/js/vendor/jquery.inputmask.bundle.min", true, ["jquery"])
            ->addDomReadyJS("$('#" . $this->id . "').inputmask(" . json_encode($options) . ");", false, "jquery.inputmask");
